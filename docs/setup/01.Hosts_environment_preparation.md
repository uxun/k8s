...
```yaml
{
  "CN": "kubernetes", # kube-apiserver 从证书中提取该字段作为请求的User name, 
  "key": {
    "algo": "rsa",
    "size": 2048
  },
  "names": [
    {
      ...
      "ST": "Shenzhen",
      "L": "GS",
      "O": "k8s", # kube-apiserver 从证书中提取该字段作为请求用户的所属Group;
      "OU": "System"
    }
  ],
  "ca": {
...
{
  "CN": "admin",
  "hosts": [],	# 不指定 hosts 字段,该证书只会被 kubectl 当做 client 证书使用
  "key": {
    "algo": "rsa",
    "size": 2048
  },
